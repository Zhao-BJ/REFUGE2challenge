...
from model import ResNet_OAM, ResNet50_for_2GAP_resize_cat, ResNet50_for_3GAP_resize_cat
...
resume = os.path.join(project_root,
        'REFUGE2challenge/demo/ResNet_for_Cls/results/ResNet50_3GAP/ResNet50_3GAP.pth')


# Data
valid_dir = os.path.join(data_root, 'Glaucoma/REFUGE/crop512/test/')
save_dir = os.path.join(project_root,
        'REFUGE2challenge/demo/ResNet_for_Cls/results/ResNet50_3GAP/ResNet50_3GAP-test')
...
# Model
#model = ResNet_OAM.resnet50(num_classes=2, pretrained=True)
#model = ResNet50_for_2GAP_resize_cat.resnet50(num_classes=num_classes, pretrained=True)
