...
batch_size = 4
num_classes = 2
visdom_env = 'REFUGE2challenge/ResNet_for_Cls/ResNet50_OAM'
...
save_dir = os.path.join(project_root, 'REFUGE2challenge/demo/ResNet_for_Cls/results/ResNet50_OAM')
...
# Model
torch.manual_seed(1)
model = ResNet_OAM.resnet50(num_classes=num_classes, pretrained=True)
if resume:
